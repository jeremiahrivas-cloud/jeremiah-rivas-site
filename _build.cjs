...
const projects = `export default function Projects({ onOpenSecurityLab }) {
  const projects = [
...
fs.writeFileSync('src/components/Projects.jsx', projects, 'utf8');
console.log('Projects.jsx written');